...
export const selectNewPiece = ( board, setSelectedSquare, setValidMoves, row, col, isWhiteTurn, isWhite, kingSquare) =>{ 
...
export const selectDifferentPiece =(setSelectedSquare, setValidMoves, board, isWhiteTurn, kingSquare, row, col) =>{
...
export const isValidMove = (board, selectedSquare, row, col, validMoves) =>{
    return board.board[selectedSquare[0]][selectedSquare[1]].piece.isValidMove(
        row,
        col,
        validMoves
      ) === true
...
export const updateEnPassant = (newBoard, row, col, isWhiteTurn, board, selectedSquare) =>{
...
export const updateKingState = (newBoard, row, col, isWhiteTurn, kingSquare, setKingSquare, selectedSquare, LETTERS) =>{
...
export const handleCheckmate = (isWhiteTurn, kingSquare, board, setHasWon, setShowWinner ) =>{
